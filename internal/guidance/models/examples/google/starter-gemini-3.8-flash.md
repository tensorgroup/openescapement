...
- Its introductory price runs through 2026-12-31 and then doubles; until then it undercuts `gemini-3.5-flash-lite` on output tokens, so revisit the Flash-Lite split when the introductory period ends.
