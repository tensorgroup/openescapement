...
- On output tokens it is cheaper than `gemini-3.8-flash` (1.5x through 2026-12-31, 3x once Flash's introductory price ends) and roughly 5x cheaper than `gemini-3.1-pro-preview`.
- Send day-to-day coding to `gemini-3.8-flash` and planning or review to `gemini-3.1-pro-preview`.
