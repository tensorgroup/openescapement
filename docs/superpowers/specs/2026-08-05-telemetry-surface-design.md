...
- `Envelope.ConfigPath` is carried in the envelope for forward compatibility and not yet consumed at ingest; identity resolution currently uses the remote alone.
